...
script = bench_script.getScript("./script/",2000,2*(10**8),script_path,"checkpoint","--checkpoint_created")
...
if False:
	for bench in benchs:
		...
		script = bench_script.getScript("./script/",2000,2*(10**8),script_path,"MSTATC3G4","--memfetch  --conf 2 --sub_channel 3 --core_freq 4GHz")
